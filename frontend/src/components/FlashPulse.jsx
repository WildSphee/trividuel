...
/**
 * FlashPulse  (gradient version)
 * ──────────────────────────────────────────────────────────────
 * Props
 * • color      – "green" | "red" | any CSS rgb() you like
 * • intensity  – 0-1   → max-opacity on the outer edge       (default 0.6)
 * • innerGap   – 0-1   → width of the clear band at centre   (default 0.4)
 * • duration   – ms    → fade-out time                       (default 400)
 * • coverage   – 0-1   → overlay width *relative to screen*  (default 1)
