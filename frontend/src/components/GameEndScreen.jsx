 ...
 * ──────────────────────────────────────────────────────────────
 * Props
 * @param {Array}    questions     – backend payload `extra.questions`
 * @param {boolean}  isWinner
 */
export default function GameEndScreen({ playerData, myUid, questions, isWinner }) {
                ...
                <div className="pixel-panel flex-1 overflow-y-auto p-4 space-y-4">
                    {questions.map((q) => {
                        ...
                        return (
                            <div
                                key={q.index}
                                className={`rounded-sm p-3 border-2 ${wasRight
