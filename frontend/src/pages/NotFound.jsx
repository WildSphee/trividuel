export default function NotFound() {
  return (
    <div className=" flex items-center justify-center min-h-screen">
      <div className="bg-white usercard p-8 text-center max-w-md">
        <img
          src="notfound.png"
          alt="Logo"
        ...
        />
        <h1 className="font-bubble text-3xl font-bold mb-4">404 - Page Not Found</h1>
        ...
        <a
          ...
          className="font-comic text-blue-500 hover:underline"
        >
